        ...
        <div className='container d-flex flex-column align-items-center'>
            ...
            <Accordion defaultActiveKey="" flush>
                <Accordion.Item eventKey='0'>
                    <Accordion.Header>what facilities does the School available ?</Accordion.Header>
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey='2'>
                    ...
                    <Accordion.Body>
                       ...
                       painting competiion, painting, competiion, and many more which help the children to achieve all round development.
                    </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey='6'>
                    <Accordion.Header>Which Publication of books are followed by yours School ?</Accordion.Header>
                    <Accordion.Body>
                    The best publication of books are N.C.E.R.T, RS Agarwal, S.Chand, R.D Sharma etc..
                    </Accordion.Body>
                </Accordion.Item>
